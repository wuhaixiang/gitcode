...
{
	rt_kprintf("英海U盘bootloader: APP启动完成\n");
	rt_kprintf("英海U盘bootloader: 正在启动RTTHREAD硬实时操作系统\n");
	rt_kprintf("英海U盘bootloader: 操作系统版本:%d.%d.%d build %s\n", RT_VERSION, RT_SUBVERSION, RT_REVISION, __DATE__);
	rt_kprintf("英海U盘bootloader: 谢谢您的使用 ! \n");
}
